      ...
      {isOpen && (
        ...
        >
          ...
          <div className="w-full max-w-6xl">
            <div className="mb-20">
              <span className="text-[11px] font-semibold uppercase tracking-[0.3em] text-[#4A93C4] block mb-4">TopTec Expertise</span>
              <h2 className="text-6xl lg:text-[82px] font-semibold text-[#202124] tracking-[-0.04em] leading-tight">Our Products.</h2>
            </div>
